...
import {ExecutionsListTestWorkingComponent} from "./executions-list-test-working.component";

let comp:    ExecutionsListTestWorkingComponent;
let fixture: ComponentFixture<ExecutionsListTestWorkingComponent>;
let de:      DebugElement;
let el:      HTMLElement;
/*
 TODO: Fix this test, now it is killing PhantomJS
 */
describe('ExecutionsListTestWorkingComponent', () => {
    let executions: any[];

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [ RouterTestingModule ],
            declarations: [ ExecutionsListTestWorkingComponent ],
            providers: [ ]
        });

        fixture = TestBed.createComponent(ExecutionsListTestWorkingComponent);
